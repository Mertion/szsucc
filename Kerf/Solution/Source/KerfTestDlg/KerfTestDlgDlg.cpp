...
CKerfTestDlgDlg::CKerfTestDlgDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CKerfTestDlgDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CKerfTestDlgDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CKerfTestDlgDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CKerfTestDlgDlg 消息处理程序

BOOL CKerfTestDlgDlg::OnInitDialog()
{
...
void CKerfTestDlgDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CKerfTestDlgDlg::OnQueryDragIcon()
{
