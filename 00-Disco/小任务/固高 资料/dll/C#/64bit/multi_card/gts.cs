...
namespace gts
{
	...
	public struct TCrdFollowStatus
	{
			...
			public unsigned long loopCount; 
	}
	public struct TCrdFollowPrm
	{
        ...
        [DllImport("gts.dll")]
        public static extern short GT_BufFollowMaster(short cardNum,short crd,ref TBufFollowMaster pBufFollowMaster,short fifo=0);
	[DllImport("gts.dll")]
        public static extern short GT_BufFollowEventCross(short cardNum,short crd,ref TBufFollowEventCross pEventCross,short fifo=0);
	[DllImport("gts.dll")]
        public static extern short GT_BufFollowEventTrigger(short cardNum,short crd,ref TBufFollowEventTrigger pEventTrigger,short fifo=0);
	[DllImport("gts.dll")]
        public static extern short GT_BufFollowStart(short cardNum,short crd,int masterSegment,int slaveSegment,int masterFrameWidth,short fifo=0);
	[DllImport("gts.dll")]
        public static extern short GT_BufFollowReturn(short cardNum,short crd,double vel,double acc,short smoothPercent,short fifo=0);
	[DllImport("gts.dll")]
        public static extern short GT_BufFollowNext(short cardNum,short crd,int width,short fifo=0);
	[DllImport("gts.dll")]
        public static extern short GT_GetCrdFollowStatus(short cardNum,short crd,out TCrdFollowStatus pStatus);
	[DllImport("gts.dll")]
        public static extern short GT_SetCrdFollowLoop(short cardNum,short crd,unsigned long loop);
	[DllImport("gts.dll")]
        public static extern short GT_GetCrdFollowLoop(short cardNum,short crd,out unsigned long pLoop);
	[DllImport("gts.dll")]
