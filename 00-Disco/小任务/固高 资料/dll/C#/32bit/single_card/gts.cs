...
namespace gts
{
	...
	[DllImport("gts.dll")]
        public static extern short GT_SetCrdFollowLoop(short crd,unsigned long loop);
	[DllImport("gts.dll")]
        public static extern short GT_GetCrdFollowLoop(short crd,out unsigned long pLoop);
	[DllImport("gts.dll")]
