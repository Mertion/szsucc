...
namespace GTSDemoCSharp
{
    ...
    public partial class Form1 : Form
    {
        ...
        short stage;//阶段标识，1表示处于Home搜索阶段，2表示处于Home回零阶段，3表示处于Index搜索阶段，4表示处于Index回零阶段
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (stage == 2)
            {
                ...
                if (0 == (status & 0x400))
                {
                    ...
                    {
                        stage = 0;
                        MessageBox.Show("Home回零完成，可以启动Index回零！");
            ...
            if (stage == 3)
            {
                ...
                {
                    stage = 0;
                    MessageBox.Show("已找到Index，可以执行Index回零！");
            ...
            if (stage == 4)
            {
                ...
                if (0 == (status & 0x400))
                {
                    ...
                    {
                        stage = 0;
                        MessageBox.Show("Index回零过程出错！");
                        
                    }
                    else
                    {
                        stage = 0;
                        MessageBox.Show("Index回零完成！");
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            capture = 0;
            //Index搜索距离
            search_index = Convert.ToInt32(textBox7.Text);
        ...
        {
            //Index偏移量
            index_offset = Convert.ToInt32(textBox8.Text);
